...
After applying `as.numeric` to `norm_samp_pos`, `vec_char`, and `vec_factor`, `norm_samp_pos` and `numeric_vec_factor` yielded valid result while `numeric_vec_char` produced NA. This occurs because character values such as in `vec_char` cannot be directly converted into numeric form. 
